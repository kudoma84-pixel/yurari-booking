      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 16px 80px" }}>
        ...
        {step === 4 && !submitted && (
          <div style={{ paddingTop: 24 }}>
            ...
            <button onClick={handleSubmit} disabled={loading} style={{ width: "100%", padding: "16px", borderRadius: 14, border: "none", cursor: loading ? "not-allowed" : "pointer", background: loading ? "#aaa" : "linear-gradient(135deg, #5a9e7a, #3a7a5a)", color: "white", fontSize: 16, fontWeight: 700, boxShadow: "0 4px 20px rgba(90,158,122,0.35)" }}>
        ...
        {step === 4 && submitted && (
          <div style={{ paddingTop: 40, textAlign: "center" }}>
            ...
            <a href={store?.lineUrl} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, width: "100%", padding: "15px", borderRadius: 14, background: "#06C755", color: "white", fontSize: 15, fontWeight: 700, textDecoration: "none", marginBottom: 12, boxSizing: "border-box", boxShadow: "0 4px 16px rgba(6,199,85,0.35)" }}>
              LINEでお問い合わせ・変更はこちら
            </a>
        ...
        {!submitted && (
          <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: "rgba(255,255,255,0.95)", backdropFilter: "blur(12px)", borderTop: "1px solid #e8ddd0", padding: "12px 16px" }}>
