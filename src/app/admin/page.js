                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ flex: 1 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                          ...
                          {c.is_first_only && <span style={{ fontSize: 10, background: "#ff8c69", color: "white", borderRadius: 10, padding: "2px 8px", fontWeight: 700 }}>初回限定</span>}
                        </div>
                        <div style={{ fontSize: 12, color: "#888" }}>{c.description}</div>
                      </div>
                      <div style={{ textAlign: "right", marginLeft: 12 }}>
                        <div style={{ fontSize: 16, fontWeight: 700, color: "#5a9e7a" }}>¥{c.price?.toLocaleString()}</div>
          ...
          <div style={{ paddingTop: 24 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {[{ id: "any", name: "指名なし", title: "", specialty: "おまかせ", img: "🌿" }, ...staffList].map(s => (
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {TIME_SLOTS.map(t => {
                    ...
                    return (
                      <div key={t} onClick={() => setTime(t)} style={{ background: isSelected ? "linear-gradient(135deg, #5a9e7a, #3a7a5a)" : "white", border: `2px solid ${isSelected ? "#5a9e7a" : "#e8ddd0"}`, borderRadius: 10, padding: "8px 14px", cursor: "pointer", fontSize: 13, fontWeight: 600, color: isSelected ? "white" : "#3a5a3a" }}>
                        {t}
                      </div>
                    );
                  })}
