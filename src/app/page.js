...
必ずfetchを使ってAPIを呼び出し、結果をJSON形式で返してください。
成功なら {"success": true}、失敗なら {"success": false, "error": "エラー内容"} を返してください。
`;
  ...
  try {
    ...
    return match ? JSON.parse(match[0]) : { success: false, error: text };
  } catch {
